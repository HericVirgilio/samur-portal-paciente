      ...
      <div className="menuHamburguer" style={menu}>
        ...
        <div className="ImagensCloseLogoSamurEncapsulamento">
          <div className="ImagensCloseLogoSamur">
            <Image
              src="/images/eduarda-ferreira.png"
              alt=""
              height={60}
              width={60}
              className="ImagemPerfilMenu"
            />
            <h2>Eduarda Ferreira</h2>
          </div>
        </div>

        <div className="DivisoriaMenuBox"></div>

        {menuHamburguerData.map((objeto) => (
          <Link
            onClick={fecharMenu}
            className="BoxMapMenuHamburguer"
            key={objeto.key}
            href={`${objeto.nomeUrl}`}
          >
            <Image
              ...
              width={25}
            />
            <p key={objeto.nome} className="TextoMapMenuHamburguer">
              {objeto.nome}
            </p>
          </Link>
        ))}
