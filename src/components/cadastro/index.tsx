...
export default function CadastroFormulario({ sendDataToParent }: Props) {
  ...
  const [regexCaracterEspecial, setRegesCaracterEspecial] = useState<
    boolean | null
  >(null);
  ...
  const EnviarFormulario = (event: FormEvent<HTMLFormElement>) => {
    ...
    if (senha === senha2 && validarSenha() && verificaEmail()) {
      ...
      setErroSenha(
        "Seu email não pode ser validado verifique os campos acima!"
      );
    } else {
  ...
  return (
    <div className="BoxForm">
      ...
      <div className="RequisitosSenha">
        ...
        <div className="ContainerVeridicadoresDeSenha">
          ...
          <p
            style={{
              display: senha.length < 8 && senha !== "" ? "block" : "none",
            }}
          >
            X
          </p>
        ...
        <div className="ContainerVeridicadoresDeSenha">
          ...
          <p
            style={{
              display: regexCaracterEspecial === false ? "block" : "none",
            }}
          >
            X
          </p>
