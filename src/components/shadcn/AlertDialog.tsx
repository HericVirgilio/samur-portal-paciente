  ...
  return (
    <AlertDialog>
      <div style={{ display: "flex" }}>
        ...
        >
          <Button variant="outline">
            <CheckboxDemo habilitado={checkbox} />
          </Button>
        </AlertDialogTrigger>
        <p>{props.objeto}</p>
      </div>
      <AlertDialogContent style={{ width: "90vw" }}>
        <AlertDialogHeader>
          <AlertDialogTitle>
            Leu e aceita a política de privacidade?
          </AlertDialogTitle>
          <AlertDialogDescription>
        ...
        <AlertDialogFooter>
          <AlertDialogCancel onClick={DesabilitarCheckBox}>
            Cancelar
          </AlertDialogCancel>
          <AlertDialogAction onClick={HabilitarCheckbox}>
            Continuar
          </AlertDialogAction>
        </AlertDialogFooter>
      </AlertDialogContent>
