...
import {
  ...
  FormDataDados,
  FormDataEndereco,
} from "@/interface/form-data.interface";
...
export default function Cadastro() {
  ...
  const [visibilidadeCadastro, setVisibilidadeCadastro] = useState({
    int: 1,
    visib: "block",
  });
  const [visibilidadeDados, setVisibilidadeDados] = useState({
    int: 2,
    visib: "block",
  });
  const [visibilidadeEndereco, setVisibilidadeEndereco] = useState({
    int: 3,
    visib: "block",
  });
    ...
    <div className="ContainerCadastro">
      <div className="DivBoxHeaderPrincipal">
        <div className="BoxVoltar">
          <Image
            src={"/icons/voltarHeaderCadastro.svg"}
            alt="Voltar"
            width={35}
            height={35}
            className="imgVoltar"
        ...
        <div className="BoxLogo">
          <Image
            src="/images/samur-principal.png"
            alt=""
            width={250}
            height={150}
            priority
